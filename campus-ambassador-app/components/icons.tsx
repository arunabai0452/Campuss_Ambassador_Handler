...
export const Logo: React.FC<IconSvgProps> = ({ size = 56, ...props }) => (
  <Image
    alt="Logo"
    height={size}
    src="/assets/logo.svg"  // Path to your SVG file
    width={size}
    {...props}
  />
);
...
export const DropDownIcon: React.FC<IconSvgProps> = ({
  ...
  <Image
    alt="DropDown"
    height={size}
    src="/assets/DropDown.svg"  // Path to your SVG file
    width={size}
    {...props}
  />
);
...
export const TimerIcon: React.FC<IconSvgProps> = ({
  ...
  <Image
    alt="DropDown"
    height={size}
    src="/assets/Time_Circle.svg"  // Path to your SVG file
    width={size}
    {...props}
  />
);
...
export const NotificationIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    <Image
      alt="Notification"
      height={size}
      src="/assets/Notification.svg"  // Path to your SVG file
      width={size}
      {...props}
    />
  );
...
export const CopyIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    <Image
      alt="Notification"
      height={size}
      src="/assets/Copy.svg"  // Path to your SVG file
      width={size}
      {...props}
    />
  );
...
export const ShareIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    <Image
      alt="Notification"
      height={size}
      src="/assets/Share.svg"  // Path to your SVG file
      width={size}
      {...props}
    />
  );
...
export const TaskIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    <Image
      alt="Notification"
      height={size}
      src="/assets/Task.svg"  // Path to your SVG file
      width={size}
      {...props}
    />
  );
...
export const StarIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    <Image
      alt="Notification"
      height={size}
      src="/assets/Star.svg"  // Path to your SVG file
      width={size}
      {...props}
    />
  );
